...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const scriptURL = 'https://script.google.com/macros/s/AKfycbx3y_EUJGP6MFF83thU6PSHT-WteFqcrY3_ddbOSSBwjgzosRFD9oNP5cPC3Zkrwv_p/exec';
      ...
      <div className="flex flex-wrap justify-between">
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className="flex items-center mb-4 text-black dark:text-gray-200">
            ...
            We need a couple of hours! No more than 2 working days since receiving your issue ticket.
          </p>
          <p className="flex items-center mb-4 text-black dark:text-gray-200">
            <i className="fas fa-envelope text-black dark:text-white text-lg mr-2"></i>
            help@gmail.com
