...
export const BentoGrid = ({ className, children }) => {
  return (
    <div
      className={cn(
        "grid md:auto-rows-[18rem] grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl px-4 mx-auto",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({ className, title, description, png }) => {
  return (
    ...
    >
      <div className="flex justify-center items-center w-full h-24 sm:h-32 md:h-40 min-h-[4rem] rounded-xl bg-white dark:from-neutral-900 dark:to-neutral-800 to-neutral-100">
        <Image
          src={png}
          className="h-1/2 sm:h-2/3 object-contain"
          alt={title}
          width={300}
          height={300}
        />
